...
<div class="header" style="">
    <div class="logo logo-dark" style="display: flex; justify-content: center; align-items: center;">
    ...
    <div class="nav-wrap">
        ...
        <ul class="nav-right">
            <li class="nav-item"
                ...
                <a title="Iniciar sesión" href="pages/login/" class="btn btn-primary text-white btn-login-custom" role="button">
